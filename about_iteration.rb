...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject passes in a core value, and uses that value in iterating
  ...
  # Files need to explicitly be closed after you finish working with them,
  # and what's probably happening is that the block automatically
  # closes the file once it's finished running.
